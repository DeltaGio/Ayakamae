...
public class ConstP3eActivity extends AppCompatActivity {
    Context context;
    Button btOk, btSair;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3e);

        context=this;
        btOk=findViewById(R.id.c_ok_p3e);
        btSair=findViewById(R.id.c_sair_p3e);
