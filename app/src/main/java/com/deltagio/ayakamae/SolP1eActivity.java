...
public class SolP1eActivity extends AppCompatActivity {
    Context context;
    Button btOk, btSair;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sol_p1e);

        context=this;
        btOk=findViewById(R.id.s_ok_p1e);
        btSair=findViewById(R.id.s_sair_p1e);
