...
public class R1a4 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r1a4);

        context=this;
        btSair=findViewById(R.id.sair_r1a4);
        btOk=findViewById(R.id.ok_r1a4);
        rbA=findViewById(R.id.a_r1a4);
        rbB=findViewById(R.id.b_r1a4);
        rbC=findViewById(R.id.c_r1a4);
        rbD=findViewById(R.id.d_r1a4);
