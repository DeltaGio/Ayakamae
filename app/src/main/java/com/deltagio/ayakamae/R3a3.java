...
public class R3a3 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r3a3);

        context=this;
        btSair=findViewById(R.id.sair_r3a3);
        btOk=findViewById(R.id.ok_r3a3);
        rbA=findViewById(R.id.a_r3a3);
        rbB=findViewById(R.id.b_r3a3);
        rbC=findViewById(R.id.c_r3a3);
