...
public class R2a2 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r2a2);

        context=this;
        btSair=findViewById(R.id.sair_r2a2);
        btOk=findViewById(R.id.ok_r2a2);
        rbA=findViewById(R.id.a_r2a2);
        rbB=findViewById(R.id.b_r2a2);
        rbC=findViewById(R.id.c_r2a2);
        rbD=findViewById(R.id.d_r2a2);
