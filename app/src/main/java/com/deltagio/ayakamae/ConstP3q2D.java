...
public class ConstP3q2D extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3q2_d);

        btOk=findViewById(R.id.c_ok_d_p3q2);
        btSair=findViewById(R.id.c_sair_d_p3q2);
        context=this;
