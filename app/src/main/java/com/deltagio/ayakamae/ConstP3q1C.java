...
public class ConstP3q1C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3q1_c);

        btOk=findViewById(R.id.c_ok_c_p3q1);
        btSair=findViewById(R.id.c_sair_c_p3q1);
        btBack=findViewById(R.id.c_back_c_p3q1);
        context=this;
