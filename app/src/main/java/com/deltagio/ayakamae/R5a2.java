...
public class R5a2 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r5a2);

        context=this;
        btSair=findViewById(R.id.sair_r5a2);
        btOk=findViewById(R.id.ok_r5a2);
        rbA=findViewById(R.id.a_r5a2);
        rbB=findViewById(R.id.b_r5a2);
        rbC=findViewById(R.id.c_r5a2);
        rbD=findViewById(R.id.d_r5a2);
