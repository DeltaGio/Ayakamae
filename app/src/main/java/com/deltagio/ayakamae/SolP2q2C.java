...
public class SolP2q2C extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sol_p2q2_c);

        btOk=findViewById(R.id.s_ok_c_p2q2);
        btSair=findViewById(R.id.s_sair_c_p2q2);
        context=this;
