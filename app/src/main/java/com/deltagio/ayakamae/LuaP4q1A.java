...
public class LuaP4q1A extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p4q1_a);

        btOk=findViewById(R.id.l_ok_a_p4q1);
        btSair=findViewById(R.id.l_sair_a_p4q1);
        context=this;
