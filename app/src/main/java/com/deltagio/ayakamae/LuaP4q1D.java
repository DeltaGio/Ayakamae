...
public class LuaP4q1D extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p4q1_d);

        btOk=findViewById(R.id.l_ok_d_p4q1);
        btSair=findViewById(R.id.l_sair_d_p4q1);
        btBack=findViewById(R.id.l_back_d_p4q1);
        context=this;
