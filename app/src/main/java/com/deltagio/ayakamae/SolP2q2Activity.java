...
public class SolP2q2Activity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sol_p2q2);

        context=this;
        bDica=findViewById(R.id.s_dica_p2q2);
        bOk=findViewById(R.id.s_ok_p2q2);
        bSair=findViewById(R.id.s_sair_p2q2);
        rA=findViewById(R.id.s_a_p2q2);
        rB=findViewById(R.id.s_b_p2q2);
        rC=findViewById(R.id.s_c_p2q2);
        rD=findViewById(R.id.s_d_p2q2);

        bDica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, SolP2q2Dica.class);
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rA.isChecked()) {
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, SolP2q2A.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, SolP2q2B.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, SolP2q2C.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, SolP2q2D.class);
                    startActivity(intent);
                }
    ...
    public void SaveScore(){
        ...
        editor.putInt(MainActivity.INT_S_P2Q2, exer);
        editor.apply();
    }
    ...
    public void loadData(){
        ...
        exer=keyExe.getInt(MainActivity.INT_S_P2Q2, 0);
