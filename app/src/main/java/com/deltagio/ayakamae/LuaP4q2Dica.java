...
public class LuaP4q2Dica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p4q2_dica);

        context=this;
        btSair=findViewById(R.id.l_sair_p4q2dica);
        btVoltar=findViewById(R.id.l_voltar_p4q2dica);
