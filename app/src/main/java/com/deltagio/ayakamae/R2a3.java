...
public class R2a3 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r2a3);

        context=this;
        btSair=findViewById(R.id.sair_r2a3);
        btOk=findViewById(R.id.ok_r2a3);
        rbA=findViewById(R.id.a_r2a3);
        rbB=findViewById(R.id.b_r2a3);
        rbC=findViewById(R.id.c_r2a3);
        rbD=findViewById(R.id.d_r2a3);
