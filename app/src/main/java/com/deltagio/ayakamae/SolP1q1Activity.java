...
public class SolP1q1Activity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sol_p1q1);

        context=this;
        bDica=findViewById(R.id.s_dica_p1q1);
        bOk=findViewById(R.id.s_ok_p1q1);
        bSair=findViewById(R.id.s_sair_p1q1);
        rA=findViewById(R.id.s_a_p1q1);
        rB=findViewById(R.id.s_b_p1q1);
        rC=findViewById(R.id.s_c_p1q1);
        rD=findViewById(R.id.s_d_p1q1);

        bDica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, SolP1q1Dica.class);
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rA.isChecked()) {
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, SolP1q1A.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, SolP1q1B.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, SolP1q1C.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, SolP1q1D.class);
                    startActivity(intent);
                }
    ...
    public void SaveScore(){
        ...
        editor.putInt(MainActivity.INT_S_P1Q1, exer);
        editor.apply();
    }
    ...
    public void loadData(){
        ...
        exer=keyExe.getInt(MainActivity.INT_S_P1Q1, 0);
