...
public class LuaP1q2Activity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p1q2);

        context=this;
        bDica=findViewById(R.id.l_dica_p1q2);
        bOk=findViewById(R.id.l_ok_p1q2);
        bSair=findViewById(R.id.l_sair_p1q2);
        rA=findViewById(R.id.l_a_p1q2);
        rB=findViewById(R.id.l_b_p1q2);
        rC=findViewById(R.id.l_c_p1q2);
        rD=findViewById(R.id.l_d_p1q2);

        bDica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, LuaP1q2Dica.class);
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rA.isChecked()) {
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP1q2A.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP1q2B.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP1q2C.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP1q2D.class);
                    startActivity(intent);
                }
    ...
    public void SaveScore(){
        ...
        editor.putInt(MainActivity.INT_L_P1Q2, exer);
        editor.apply();
    }
    ...
    public void loadData(){
        ...
        exer=keyExe.getInt(MainActivity.INT_L_P1Q2, 0);
