...
public class SolP2q2B extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sol_p2q2_b);

        btOk=findViewById(R.id.s_ok_b_p2q2);
        btSair=findViewById(R.id.s_sair_b_p2q2);
        context=this;
