...
public class ConstP1q2DActivity extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p1q2_d);

        btOk=findViewById(R.id.c_ok_d_p1q2);
        btSair=findViewById(R.id.c_sair_d_p1q2);
        context=this;
