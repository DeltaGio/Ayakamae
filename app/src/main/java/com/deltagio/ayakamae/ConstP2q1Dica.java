...
public class ConstP2q1Dica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p2q1_dica);

        context=this;
        btSair=findViewById(R.id.c_sair_p2q1dica);
        btVoltar=findViewById(R.id.c_voltar_p2q1dica);
