...
public class LuaP4q1Activity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p4q1);

        context=this;
        bDica=findViewById(R.id.l_dica_p4q1);
        bOk=findViewById(R.id.l_ok_p4q1);
        bSair=findViewById(R.id.l_sair_p4q1);
        rA=findViewById(R.id.l_a_p4q1);
        rB=findViewById(R.id.l_b_p4q1);
        rC=findViewById(R.id.l_c_p4q1);
        rD=findViewById(R.id.l_d_p4q1);

        bDica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, LuaP4q1Dica.class);
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rA.isChecked()) {
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP4q1A.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP4q1B.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP4q1C.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP4q1D.class);
                    startActivity(intent);
                }
    ...
    public void SaveScore(){
        ...
        editor.putInt(MainActivity.INT_L_P4Q1, exer);
        editor.apply();
    }
    ...
    public void loadData(){
        ...
        exer=keyExe.getInt(MainActivity.INT_L_P4Q1, 0);
