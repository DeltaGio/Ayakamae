...
public class LuaP4q1C extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p4q1_c);

        btOk=findViewById(R.id.l_ok_c_p4q1);
        btSair=findViewById(R.id.l_sair_c_p4q1);
        context=this;
