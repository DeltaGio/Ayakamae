...
public class LuaP4q1Dica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p4q1_dica);

        context=this;
        btSair=findViewById(R.id.l_sair_p4q1dica);
        btVoltar=findViewById(R.id.l_voltar_p4q1dica);
