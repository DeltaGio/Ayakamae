...
public class SolP2q2D extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sol_p2q2_d);

        btOk=findViewById(R.id.s_ok_d_p2q2);
        btSair=findViewById(R.id.s_sair_d_p2q2);
        context=this;
