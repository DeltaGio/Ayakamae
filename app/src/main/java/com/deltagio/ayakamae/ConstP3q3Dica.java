...
public class ConstP3q3Dica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3q3_dica);

        context=this;
        btSair=findViewById(R.id.c_sair_p3q3dica);
        btVoltar=findViewById(R.id.c_voltar_p3q3dica);
