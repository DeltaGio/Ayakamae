...
public class ConstP3q2C extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3q2_c);

        btOk=findViewById(R.id.c_ok_c_p3q2);
        btSair=findViewById(R.id.c_sair_c_p3q2);
        context=this;
