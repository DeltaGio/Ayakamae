...
public class R3a2 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r3a2);

        context=this;
        btSair=findViewById(R.id.sair_r3a2);
        btOk=findViewById(R.id.ok_r3a2);
        rbA=findViewById(R.id.a_r3a2);
        rbB=findViewById(R.id.b_r3a2);
        rbC=findViewById(R.id.c_r3a2);
        rbD=findViewById(R.id.d_r3a2);
