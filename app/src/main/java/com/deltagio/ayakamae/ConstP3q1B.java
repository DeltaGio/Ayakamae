...
public class ConstP3q1B extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3q1_b);

        btOk=findViewById(R.id.c_ok_b_p3q1);
        btSair=findViewById(R.id.c_sair_b_p3q1);
        context=this;
