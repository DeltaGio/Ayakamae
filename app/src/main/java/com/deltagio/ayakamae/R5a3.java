...
public class R5a3 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r5a3);

        context=this;
        btSair=findViewById(R.id.sair_r5a3);
        btOk=findViewById(R.id.ok_r5a3);
        rbA=findViewById(R.id.a_r5a3);
        rbB=findViewById(R.id.b_r5a3);
        rbC=findViewById(R.id.c_r5a3);
