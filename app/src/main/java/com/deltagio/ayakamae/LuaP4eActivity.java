...
public class LuaP4eActivity extends AppCompatActivity {
    Context context;
    Button btOk, btSair;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p4e);

        context=this;
        btOk=findViewById(R.id.l_ok_p4e);
        btSair=findViewById(R.id.l_sair_p4e);
