...
public class ConstP1q2BActivity extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p1q2_b);

        btOk=findViewById(R.id.c_ok_b_p1q2);
        btSair=findViewById(R.id.c_sair_b_p1q2);
        context=this;
