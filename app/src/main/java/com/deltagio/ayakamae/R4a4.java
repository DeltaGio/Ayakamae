...
public class R4a4 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r4a4);

        context=this;
        btSair=findViewById(R.id.sair_r4a4);
        btOk=findViewById(R.id.ok_r4a4);
        rbA=findViewById(R.id.a_r4a4);
        rbB=findViewById(R.id.b_r4a4);
        rbC=findViewById(R.id.c_r4a4);
