...
public class ConstP2q1Activity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p2q1);

        context=this;
        bDica=findViewById(R.id.c_dica_p2q1);
        bOk=findViewById(R.id.c_ok_p2q1);
        bSair=findViewById(R.id.c_sair_p2q1);
        rA=findViewById(R.id.c_a_p2q1);
        rB=findViewById(R.id.c_b_p2q1);
        rC=findViewById(R.id.c_c_p2q1);

        bDica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, ConstP2q1Dica.class);
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rA.isChecked()) {
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, ConstP2q1A.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, ConstP2q1B.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, ConstP2q1C.class);
                    startActivity(intent);
                }
    ...
    public void SaveScore(){
        ...
        editor.putInt(MainActivity.INT_C_P2Q1, exer);
        editor.apply();
    }
    ...
    public void loadData(){
        ...
        exer=keyExe.getInt(MainActivity.INT_C_P2Q1, 0);
