...
public class R3a4 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r3a4);

        context=this;
        btSair=findViewById(R.id.sair_r3a4);
        btOk=findViewById(R.id.ok_r3a4);
        rbA=findViewById(R.id.a_r3a4);
        rbB=findViewById(R.id.b_r3a4);
        rbC=findViewById(R.id.c_r3a4);
