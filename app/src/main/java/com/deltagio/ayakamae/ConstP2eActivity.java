...
public class ConstP2eActivity extends AppCompatActivity {
    Context context;
    Button btOk, btSair;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p2e);

        context=this;
        btOk=findViewById(R.id.c_ok_p2e);
        btSair=findViewById(R.id.c_sair_p2e);
