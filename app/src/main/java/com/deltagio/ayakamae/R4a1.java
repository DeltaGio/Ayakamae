...
public class R4a1 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r4a1);

        context=this;
        btSair=findViewById(R.id.sair_r4a1);
        btOk=findViewById(R.id.ok_r4a1);
        rbA=findViewById(R.id.a_r4a1);
        rbB=findViewById(R.id.b_r4a1);
        rbC=findViewById(R.id.c_r4a1);
        rbD=findViewById(R.id.d_r4a1);
