...
public class ConstP3q1D extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3q1_d);

        btOk=findViewById(R.id.c_ok_d_p3q1);
        btSair=findViewById(R.id.c_sair_d_p3q1);
        context=this;
