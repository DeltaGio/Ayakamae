...
public class ConstP3q1Dica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3q1_dica);

        context=this;
        btSair=findViewById(R.id.c_sair_p3q1dica);
        btVoltar=findViewById(R.id.c_voltar_p3q1dica);
