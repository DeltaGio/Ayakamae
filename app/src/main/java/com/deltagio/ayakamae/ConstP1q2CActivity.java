...
public class ConstP1q2CActivity extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p1q2_c);

        btOk=findViewById(R.id.c_ok_c_p1q2);
        btSair=findViewById(R.id.c_sair_c_p1q2);
        context=this;
