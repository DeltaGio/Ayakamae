...
public class ConstP3q2A extends AppCompatActivity {
    Button btOk, btSair;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p3q2_a);

        btOk=findViewById(R.id.c_ok_a_p3q2);
        btSair=findViewById(R.id.c_sair_a_p3q2);
        context=this;
