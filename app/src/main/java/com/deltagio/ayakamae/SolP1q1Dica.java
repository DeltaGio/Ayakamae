...
public class SolP1q1Dica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sol_p1q1_dica);

        context=this;
        btSair=findViewById(R.id.s_sair_p1q1dica);
        btVoltar=findViewById(R.id.s_voltar_p1q1dica);
