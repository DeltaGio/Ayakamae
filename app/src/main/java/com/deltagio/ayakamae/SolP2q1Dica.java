...
public class SolP2q1Dica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sol_p2q1_dica);

        context=this;
        btSair=findViewById(R.id.s_sair_p2q1dica);
        btVoltar=findViewById(R.id.s_voltar_p2q1dica);
