...
public class LuaP2q3Activity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lua_p2q3);

        context=this;
        bDica=findViewById(R.id.l_dica_p2q3);
        bOk=findViewById(R.id.l_ok_p2q3);
        bSair=findViewById(R.id.l_sair_p2q3);
        rA=findViewById(R.id.l_a_p2q3);
        rB=findViewById(R.id.l_b_p2q3);
        rC=findViewById(R.id.l_c_p2q3);
        rD=findViewById(R.id.l_d_p2q3);

        bDica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, LuaP2q3Dica.class);
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rA.isChecked()) {
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP2q3A.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP2q3B.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP2q3C.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, LuaP2q3D.class);
                    startActivity(intent);
                }
    ...
    public void SaveScore(){
        ...
        editor.putInt(MainActivity.INT_L_P2Q3, exer);
        editor.apply();
    }
    ...
    public void loadData(){
        ...
        exer=keyExe.getInt(MainActivity.INT_L_P2Q3, 0);
