...
public class ConstP2q2Activity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.const_p2q2);

        context=this;
        bDica=findViewById(R.id.c_dica_p2q2);
        bOk=findViewById(R.id.c_ok_p2q2);
        bSair=findViewById(R.id.c_sair_p2q2);
        rA=findViewById(R.id.c_a_p2q2);
        rB=findViewById(R.id.c_b_p2q2);
        rC=findViewById(R.id.c_c_p2q2);

        bDica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, ConstP2q2Dica.class);
        ...
        bOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rA.isChecked()) {
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, ConstP2q2A.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, ConstP2q2B.class);
                    startActivity(intent);
                    ...
                    n ++;
                    SaveN();
                    Intent intent = new Intent(context, ConstP2q2C.class);
                    startActivity(intent);
                }
    ...
    public void SaveScore(){
        ...
        editor.putInt(MainActivity.INT_C_P2Q2, exer);
        editor.apply();
    }
    ...
    public void loadData(){
        ...
        exer=keyExe.getInt(MainActivity.INT_C_P2Q2, 0);
