...
public class R1a3 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r1a3);

        context=this;
        btSair=findViewById(R.id.sair_r1a3);
        btOk=findViewById(R.id.ok_r1a3);
        rbA=findViewById(R.id.a_r1a3);
        rbB=findViewById(R.id.b_r1a3);
        rbC=findViewById(R.id.c_r1a3);
        rbD=findViewById(R.id.d_r1a3);
