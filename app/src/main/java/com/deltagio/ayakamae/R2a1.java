...
public class R2a1 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r2a1);

        context=this;
        btSair=findViewById(R.id.sair_r2a1);
        btOk=findViewById(R.id.ok_r2a1);
        rbA=findViewById(R.id.a_r2a1);
        rbB=findViewById(R.id.b_r2a1);
        rbC=findViewById(R.id.c_r2a1);
        rbD=findViewById(R.id.d_r2a1);
