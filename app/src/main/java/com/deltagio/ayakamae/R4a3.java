...
public class R4a3 extends AppCompatActivity {
    Button btSair, btOk;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r4a3);

        context=this;
        btSair=findViewById(R.id.sair_r4a3);
        btOk=findViewById(R.id.ok_r4a3);
        rbA=findViewById(R.id.a_r4a3);
        rbB=findViewById(R.id.b_r4a3);
        rbC=findViewById(R.id.c_r4a3);
        rbD=findViewById(R.id.d_r4a3);
    ...
    public void saveR(){
        ...
        editor.putInt(RFinalActivity.REV_4, rx);
        editor.apply();
    }
    ...
    public void nextScreen(){
        ...
        activityList.add(R5a1.class);
        activityList.add(R5a2.class);
        activityList.add(R5a3.class);
        activityList.add(R5a4.class);
        ...
        switch (number) {
            case 1:
                revAlea = R5a1.class;
                activityList.remove(R5a1.class);
                break;
            case 2:
                revAlea = R5a2.class;
                activityList.remove(R5a2.class);
                break;
            case 3:
                revAlea = R5a3.class;
                activityList.remove(R5a3.class);
                break;
            default:
                revAlea = R5a4.class;
                activityList.remove(R5a4.class);
                break;
        }
